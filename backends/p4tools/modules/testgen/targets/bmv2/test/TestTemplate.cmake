...
macro(check_bmv2_with_ptf testfile testfolder p4test)
  ...
  file(APPEND ${testfile} "do\n")
  file(APPEND ${testfile} "\techo \"Found \${item}\"\n")
  file(APPEND ${testfile} "\t sudo -E python3 ${P4C_SOURCE_DIR}/backends/p4tools/modules/testgen/targets/bmv2/backend/ptf/run-bmv2-ptf-test.py -tf \${item} ${P4C_SOURCE_DIR} -pfn ${P4C_SOURCE_DIR}/${p4test} \n")
  file(APPEND ${testfile} "done\n")
