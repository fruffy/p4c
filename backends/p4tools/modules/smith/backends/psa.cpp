...
IR::P4Parser *PSA::gen_switch_ingress_parser() {
    ...
    params.push_back(parameter::gen_param(IR::Direction::None, "pkt", "packet_in"));
    params.push_back(parameter::gen_param(IR::Direction::Out, "hdr", SYS_HDR_NAME));
    params.push_back(parameter::gen_param(IR::Direction::InOut, "user_meta", "metadata_t"));
    params.push_back(
        parameter::gen_param(IR::Direction::In, "istd", "psa_ingress_parser_input_metadata_t"));
    params.push_back(parameter::gen_param(IR::Direction::In, "resubmit_meta", "empty_t"));
    params.push_back(parameter::gen_param(IR::Direction::In, "recirculate_meta", "empty_t"));
...
IR::P4Control *PSA::gen_switch_ingress() {
    ...
    IR::IndexedVector<IR::Parameter> params;
    params.push_back(parameter::gen_param(IR::Direction::InOut, "h", SYS_HDR_NAME));
    params.push_back(parameter::gen_param(IR::Direction::InOut, "user_meta", "metadata_t"));
    params.push_back(
        parameter::gen_param(IR::Direction::In, "istd", "psa_ingress_input_metadata_t"));
    params.push_back(
        parameter::gen_param(IR::Direction::InOut, "ostd", "psa_ingress_output_metadata_t"));
...
IR::P4Control *PSA::gen_switch_ingress_deparser() {
    ...
    IR::IndexedVector<IR::Parameter> params;
    params.push_back(parameter::gen_param(IR::Direction::None, "pkt", "packet_out"));
    params.push_back(parameter::gen_param(IR::Direction::Out, "clone_i2e_meta", "empty_t"));
    params.push_back(parameter::gen_param(IR::Direction::Out, "resubmit_meta", "empty_t"));
    params.push_back(parameter::gen_param(IR::Direction::Out, "normal_meta", "empty_t"));
    params.push_back(parameter::gen_param(IR::Direction::InOut, "h", SYS_HDR_NAME));
    params.push_back(parameter::gen_param(IR::Direction::In, "user_meta", "metadata_t"));
    params.push_back(
        parameter::gen_param(IR::Direction::In, "istd", "psa_ingress_output_metadata_t"));
    auto par_list = new IR::ParameterList(params);
...
IR::P4Parser *PSA::gen_switch_egress_parser() {
    ...
    params.push_back(parameter::gen_param(IR::Direction::InOut, "user_meta", "metadata_t"));
    params.push_back(
        parameter::gen_param(IR::Direction::In, "istd", "psa_egress_parser_input_metadata_t"));
    params.push_back(parameter::gen_param(IR::Direction::In, "normal_meta", "empty_t"));
    params.push_back(parameter::gen_param(IR::Direction::In, "clone_i2e_meta", "empty_t"));
    params.push_back(parameter::gen_param(IR::Direction::In, "clone_e2e_meta", "empty_t"));
    auto par_list = new IR::ParameterList(params);
...
IR::P4Control *PSA::gen_switch_egress() {
    ...
    params.push_back(parameter::gen_param(IR::Direction::InOut, "user_meta", "metadata_t"));
    params.push_back(
        parameter::gen_param(IR::Direction::In, "istd", "psa_egress_input_metadata_t"));
    params.push_back(
        parameter::gen_param(IR::Direction::InOut, "ostd", "psa_egress_output_metadata_t"));
    auto par_list = new IR::ParameterList(params);
...
IR::P4Control *PSA::gen_switch_egress_deparser() {
    ...
    IR::IndexedVector<IR::Parameter> params;
    params.push_back(parameter::gen_param(IR::Direction::None, "pkt", "packet_out"));
    params.push_back(parameter::gen_param(IR::Direction::Out, "clone_e2e_meta", "empty_t"));
    params.push_back(parameter::gen_param(IR::Direction::Out, "recirculate_meta", "empty_t"));
    params.push_back(parameter::gen_param(IR::Direction::InOut, "h", SYS_HDR_NAME));
    params.push_back(parameter::gen_param(IR::Direction::In, "user_meta", "metadata_t"));
    params.push_back(
        parameter::gen_param(IR::Direction::In, "istd", "psa_egress_output_metadata_t"));
    params.push_back(
        parameter::gen_param(IR::Direction::In, "edstd", "psa_egress_deparser_input_metadata_t"));
    auto par_list = new IR::ParameterList(params);
