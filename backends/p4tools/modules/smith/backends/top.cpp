...
IR::Type_Parser *Top::gen_parser_type() {
    IR::IndexedVector<IR::Parameter> params;
    params.push_back(parameter::gen_param(IR::Direction::None, "b", "packet_in"));
    params.push_back(parameter::gen_param(IR::Direction::Out, "hdr", SYS_HDR_NAME));
    auto par_list = new IR::ParameterList(params);
...
IR::Type_Control *Top::gen_ingress_type() {
    IR::IndexedVector<IR::Parameter> params;
    params.push_back(parameter::gen_param(IR::Direction::InOut, "hdr", SYS_HDR_NAME));
    auto par_list = new IR::ParameterList(params);
...
IR::Type_Package *Top::gen_package() {
    ...
    params.push_back(parameter::gen_param(IR::Direction::None, "ig", "Ingress"));
    auto par_list = new IR::ParameterList(params);
