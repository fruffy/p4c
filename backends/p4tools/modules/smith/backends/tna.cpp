...
IR::P4Parser *TNA::gen_switch_ingress_parser() {
    ...
    params.push_back(parameter::gen_param(IR::Direction::Out, "ig_md", "ingress_metadata_t"));
    params.push_back(
        parameter::gen_param(IR::Direction::Out, "ig_intr_md", "ingress_intrinsic_metadata_t"));
...
IR::P4Control *TNA::gen_switch_ingress() {
    ...
    params.push_back(parameter::gen_param(IR::Direction::InOut, "ig_md", "ingress_metadata_t"));
    params.push_back(
        parameter::gen_param(IR::Direction::In, "ig_intr_md", "ingress_intrinsic_metadata_t"));
    params.push_back(parameter::gen_param(IR::Direction::In, "ig_prsr_md",
                                          "ingress_intrinsic_metadata_from_parser_t"));
    params.push_back(parameter::gen_param(IR::Direction::InOut, "ig_dprsr_md",
                                          "ingress_intrinsic_metadata_for_deparser_t"));
    params.push_back(parameter::gen_param(IR::Direction::InOut, "ig_tm_md",
...
IR::P4Control *TNA::gen_switch_ingress_deparser() {
    ...
    params.push_back(parameter::gen_param(IR::Direction::InOut, "h", SYS_HDR_NAME));
    params.push_back(parameter::gen_param(IR::Direction::In, "ig_md", "ingress_metadata_t"));
    params.push_back(parameter::gen_param(IR::Direction::In, "ig_dprsr_md",
                                          "ingress_intrinsic_metadata_for_deparser_t"));
    auto par_list = new IR::ParameterList(params);
...
IR::P4Parser *TNA::gen_switch_egress_parser() {
    ...
    params.push_back(parameter::gen_param(IR::Direction::Out, "eg_md", "egress_metadata_t"));
    params.push_back(
        parameter::gen_param(IR::Direction::Out, "eg_intr_md", "egress_intrinsic_metadata_t"));
    auto par_list = new IR::ParameterList(params);
...
IR::P4Control *TNA::gen_switch_egress_deparser() {
    ...
    params.push_back(parameter::gen_param(IR::Direction::None, "pkt", "packet_out"));
    params.push_back(parameter::gen_param(IR::Direction::InOut, "h", SYS_HDR_NAME));
    params.push_back(parameter::gen_param(IR::Direction::In, "eg_md", "egress_metadata_t"));
    params.push_back(parameter::gen_param(IR::Direction::In, "eg_intr_dprs_md",
...
IR::P4Control *TNA::gen_switch_egress() {
    ...
    IR::IndexedVector<IR::Parameter> params;
    params.push_back(parameter::gen_param(IR::Direction::InOut, "h", SYS_HDR_NAME));
    params.push_back(parameter::gen_param(IR::Direction::InOut, "eg_md", "egress_metadata_t"));
    params.push_back(
        parameter::gen_param(IR::Direction::In, "eg_intr_md", "egress_intrinsic_metadata_t"));
    params.push_back(parameter::gen_param(IR::Direction::In, "eg_intr_md_from_prsr",
                                          "egress_intrinsic_metadata_from_parser_t"));
    params.push_back(parameter::gen_param(IR::Direction::InOut, "eg_intr_dprs_md",
                                          "egress_intrinsic_metadata_for_deparser_t"));
    params.push_back(parameter::gen_param(IR::Direction::InOut, "eg_intr_oport_md",
